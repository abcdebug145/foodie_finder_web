    ...
    return (
        <div ref={containerRef} className="app-loader">
            ...
            <span className="app-loader__bg-decor" style={{ position: "absolute", display: "flex" }}>
                ...
                >
                    <path d="M12 2L2 22h20L12 2zM12 18a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zM9 13a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm6 0a1 1 0 1 1 0-2 1 1 0 0 1 0 2z" />
                </svg>
            </span>
            <span className="app-loader__bg-decor" style={{ position: "absolute", display: "flex" }}>
                <svg
            ...
            <span className="app-loader__bg-decor" style={{ position: "absolute", display: "flex" }}>
                <svg
                    ...
                    strokeLinejoin="round"
                >
                    <path d="M12 2v4M5 12h14v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7zm0 0c0-3 3-5 7-5s7 2 7 5" />
                </svg>
            </span>
            <span className="app-loader__bg-decor" style={{ position: "absolute", display: "flex" }}>
                <svg
                ...
                >
                    ...
                    <path d="M8 8.5a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1zm8 0a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1zm-4 4a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1zm-4 4a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1zm8 0a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1z" />
                </svg>
            </span>
            <span className="app-loader__bg-decor" style={{ position: "absolute", display: "flex" }}>
                <svg
                    ...
                    strokeLinejoin="round"
                >
                    <path d="M12 22c4.97 0 9-3.03 9-8 0-4.5-3-6-9-6s-9 1.5-9 6c0 4.97 4.03 8 9 8z" />
                    <path d="M12 8V5c0-1.66 1-3 3-3" />
                </svg>
            </span>
            ...
            <div className="app-loader__content">
                <div className="app-loader__logo-container">
                    <span
                        className="app-loader__steam"
                        style={{ left: "30%", display: "inline-flex", color: "var(--primary)" }}
                    >
                        <svg
                            width="12"
                            height="20"
                    ...
                    <span
                        className="app-loader__steam"
                        style={{ left: "50%", display: "inline-flex", color: "var(--primary)" }}
                    >
                        <svg
                            width="12"
                            height="20"
                    ...
                    <span
                        className="app-loader__steam"
                        style={{ left: "70%", display: "inline-flex", color: "var(--primary)" }}
                    >
                        <svg
                            width="12"
                            height="20"
                ...
                <p className="app-loader__subtitle">Đăng nhập để có trải nghiệm tốt hơn</p>
            </div>
        </div>
    );
}
